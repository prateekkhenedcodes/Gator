...
func main() {
	...
	cmds.Register("addfeed", config.HandleAddFeed)
	cmds.Register("feeds", config.HandleFeed)
	cmds.Register("follow", config.HandleFollow)
	cmds.Register("following", config.HandleFollowing)
